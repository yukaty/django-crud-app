...
urlpatterns = [
    ...
    path('crud/update/<int:pk>/', views.ProductUpdateView.as_view(), name="update"),
    ...
    path('logout/', LogoutView.as_view(), name='logout'), # built-in view
]

# Static file access for development
if settings.DEBUG:
